...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create attendee' do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { attended: @attendee.attended, rsvp: @attendee.rsvp } }
    end
  ...
  test 'should update attendee' do
    patch attendee_url(@attendee), params: { attendee: { attended: @attendee.attended, rsvp: @attendee.rsvp } }
