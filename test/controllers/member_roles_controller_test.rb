...
class MemberRolesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create member_role' do
    assert_difference('MemberRole.count') do
      post member_roles_url, params: { member_role: { id: @member_role.id, member_id: @member_role.member_id, role_id: @member_role.role_id } }
    end
  ...
  test 'should update member_role' do
    patch member_role_url(@member_role),
          params: { member_role: { id: @member_role.id, member_id: @member_role.member_id, role_id: @member_role.role_id } }
